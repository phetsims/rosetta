...
the `clientConfig.js` file when Rosetta is started. For more info on this, see the README in the
...
systemd service (see below). Then, you should be able to simply `sudo -u phet-admin grunt update-dependencies`.
